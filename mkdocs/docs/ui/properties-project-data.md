...
The **Project Data** panel lives in **Properties editor → Scene Properties** (scene icon). It is the central location for all named lists that MaStro uses across the project. All lists are shared by every object in the scene.
