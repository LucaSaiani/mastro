...
def findFilletCenter(center, vertList, givenWidth = None, givenRadius = None):
	...
	for i, el in enumerate(vertList):
		...
		# tmpLine.sort()
		# indexTmpLine = findElementIndex(tmpLine, lines, 0)
								...
								if type == "corner":
									...
									if testEqualProperty(verts, "width"):
										...
										if (oppositePoint):
											...
											plt.plot(oppositePoint[0], oppositePoint[1], marker=".", markersize=10, color="blue")
									...
									# in case street widths are different
										...
										if i == 0:
											...
											if slope != None:
												...
												oppositeFilletCenter = pointFromCenter(filletCenter, slope, direction, 2 * dist) 	# the newFilleCenter has twice distance between the filletCenter and the corner
										...
										# print("mainSlope", mainSlope, oppositePoint)
