...
from .check_new_scenes import check_new_scenes
from .update_view3D_panels import update_view3D_panels
...
def updates(scene, depsgraph):
    ...
    #             if scene.mastro_previous_selection_object_name != obj.name:
    #                 scene.mastro_previous_selection_object_name = obj.name
    #                 scene.mastro_previous_selection_face_id = -1
    ...
    #                                 scene.mastro_previous_selection_edge_id = active_edge.index
    #                                 wall_type = bm.edges[scene.mastro_previous_selection_edge_id][bMesh_wall_type]
    #                                 wall_normal = bm.edges[scene.mastro_previous_selection_edge_id][bMesh_wall_normal]
    ...
    #                                 if len(selected_edges) > 0:
    #                                     # for e in selected_edges:
    #                                     scene.mastro_previous_selection_edge_id = selected_edges[-1].index
    ...
    #                         #         scene.mastro_previous_selection_face_id = active_face
    #                         # else:
    #                         #     selected_faces = [face for face in bm.faces if face.select]
    #                         #     if len(selected_faces) > 0:
    #                         #         for f in selected_faces:
    #                         #             scene.mastro_previous_selection_face_id = f.index
    #                         #     else:
    #                         #         scene.mastro_previous_selection_face_id = -1
    #                         # if scene.mastro_previous_selection_face_id != -1:
    ...
    #                                     list_storey_B = 11
    #                                     typology = 0
    #                                 if scene.mastro_attribute_mass_storeys != storeys:
    #                                     scene.mastro_attribute_mass_storeys = storeys
    #                                 # if bpy.context.scene.mastro_attribute_mass_storeys != storeys:
    ...
    #                                         depth = bpy.context.scene.mastro_attribute_block_depth
    #                                         if depth == 0:
    #                                             depth = 18
    ...
    #                                         bpy.context.scene.mastro_attribute_block_side_angle = 0
    ...
    #                                 if bpy.context.scene.mastro_attribute_block_side_angle != angle:
    #                                     bpy.context.scene.mastro_attribute_block_side_angle = angle   
    ...
    #                                 if len(selected_edges) == 1:
    #                                     if bpy.context.scene.mastro_attribute_mass_storeys != storeys:
    #                                         bpy.context.scene.mastro_attribute_mass_storeys = storeys
    ...
    #                             #updating the information in UI
    #                             bm.edges.ensure_lookup_table()
    #                             street_type = bm.edges[scene.mastro_previous_selection_edge_id][bMesh_street_type]
    #                             # street type name
