...
# from .ss_OBJECT_OT_Set_Edge_Attribute_Angle import OBJECT_OT_Set_Edge_Attribute_Angle
# from .ss_OBJECT_OT_Set_Edge_Attribute_Depth import OBJECT_OT_Set_Edge_Attribute_Depth
# from .ss_OBJECT_OT_Set_Edge_Attribute_Normal import OBJECT_OT_Set_Edge_Attribute_Normal
...
# from .ss_OBJECT_OT_Set_Extras import OBJECT_OT_Set_Vertex_Extra, OBJECT_OT_Set_Edge_Extra, OBJECT_OT_Set_Face_Extra
...
# from .ss_OBJECT_OT_Set_Floor_Id import OBJECT_OT_Set_Floor_Id
from .OBJECT_OT_Set_Street_Id import OBJECT_OT_Set_Street_Id
# from .ss_OBJECT_OT_Set_Wall_Id import OBJECT_OT_Set_Wall_Id
...
classes = (
    ...
    # ss_OBJECT_OT_Set_Floor_Id,
    OBJECT_OT_Set_Street_Id,
    # ss_OBJECT_OT_Set_Wall_Id,
