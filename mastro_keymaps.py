...
# Used to store addon keymaps [(keymap, keymap_item), ...]
addon_keymaps = []

# Keymaps to look for keymap_items in, this should pair with contexts in 'context' variable in mastro_menu.py
keymap_names = ['3D View', 'Object Mode', 'Mesh']
