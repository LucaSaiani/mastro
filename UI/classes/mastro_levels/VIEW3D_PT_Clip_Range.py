...
from ....Utils.mastro_levels.clip_range import (
    is_top_bottom_ortho, is_bottom_ortho, is_clip_range_unlimited,
)
...
def _draw_clip_range(self, context):
    ...
    layout.prop(scene, "mastro_clip_range_set_id", text="Set")
    ...
    unlimited = is_clip_range_unlimited(scene)
    ...
    row.template_list("PROPERTIES_UL_Clip_Range_Levels", "clip_range_levels", scene,
                       "mastro_level_list", scene, "mastro_clip_range_list_index", rows=4)
