...
def xy_constraint_button(self, context):
    ...
    icon_value = icons.icon_id('xy_on') if constraint_xy_settings.constraint_xy_on else icons.icon_id('xy_off')
    row.prop(constraint_xy_settings, "constraint_xy_on", text="", icon_value=icon_value)
